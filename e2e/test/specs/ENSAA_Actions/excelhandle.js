...
module.exports = {
  'Excel read and write' : function (client) {
   ...
   let filename1 = 'e2e\\test\\enssa-testuser-latest -updated.xlsx';
    ...
    workbook.xlsx.readFile(filename1)
        ...
        str_add_empemail= 'abc'+ Math.floor(Math.random() * 10000) + 1 +'@gmail.com';

        //console.log(str_add)
  workbook.getWorksheet('Sheet1').addRow([str_add_fname,'',str_add_lname,str_add_empemail,'viewer','school','Aschool','9870987896','12GT','California','CA','4000','TEACHER','ABC School']);
